...
function LiveGrid(element, options) {
  ...
  this.loadingDiv.innerHTML = '<span style="background-color: #888; -moz-opacity: 1; border: solid black thin; margin: auto; height:3em; position:absolute; top:0px; bottom: 0px;">loading data...<br/><img src="/assets/mozilla_blu.gif"/></span>';
...
LiveGrid.prototype.buildTable = function() {
  ...
  for (var j=0; j < ncols; j++) {
    ...
    if (j==0) {
      ...
      clear.src="/assets/locationbar_erase.png";
