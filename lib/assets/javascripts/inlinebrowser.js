(function($) {
    ...
    return this.each(function() {
      ...
      try {
        ...
        if (!elem.hasClass("notnull")) {
          elem.prepend('<a class="button erease" title="Eingabe löschen"><img src="/assets/locationbar_erase.png"/></a>');
        }
        var ignore_selected_text = elem.attr('ignore_selected_text');
        if (ignore_selected_text != null) {
          elem.append('<a class="button openib"><img src="/assets/find.png"/></a>' +
            '<div class="ibdialog"><div class="livegrid"></div></div>');
        } else {
          elem.append('<span class="ib_selected_text"></span><a class="button openib"><img src="/assets/find.png"/></a>' +
            '<div class="ibdialog"><div class="livegrid"></div></div>');
        }
  ...
  $.fn.inlineshow = function(options) {
    return this.each(function(){
      ...
      var url = elem.attr('url');
      elem.append('<a class="button"><img src="/assets/filefind.png"/></a><div class="dialoginhalt">Lade Daten</div>');
...
//          dlginhalt.find(".inlineshow").inlineshow({});
  ...
  $.fn.inlinenew = function(options) {
    return this.each(function(){
      ...
      var sel = elem.parent().find("select, input:hidden");
      var url = elem.attr('url');
      elem.append('<a class="button"><img src="/assets/filenew.png"/></a><div class="newinline">Lade Formular</div>');
      var link = elem.find("a");
      ...
      link.click(function() {
        ...
        inhalt.load(url, null, function(responseText, textStatus, xhr) {
          if (xhr.status==200) {
            ...
            jQuery(this).prepend('<a class="button"><img src="/assets/cancel.png"/></a>');
